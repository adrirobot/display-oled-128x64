...
> Apri questa pagina in [https://adrirobot.github.io/display-oled-128x64/](https://adrirobot.github.io/display-oled-128x64/)
...
* cerca **https://github.com/adrirobot/display-oled-128x64** ed importa

## Modifica questo progetto ![Badge stato build](https://github.com/adrirobot/display-oled-128x64/workflows/MakeCode/badge.svg)

Per modificare questa repository in MakeCode.

* apri [https://makecode.microbit.org/](https://makecode.microbit.org/)
* clicca su **Importa** quindi fai clic su **Importa INDIRIZZO**
* incolla **https://github.com/adrirobot/display-oled-128x64** e clicca importa
...
![Un'immagine renderizzata dei blocchi](https://github.com/adrirobot/display-oled-128x64/raw/master/.github/makecode/blocks.png)
